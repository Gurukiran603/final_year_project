...
# dataset loader -train r test loader 
...
# trainer object - forward, backward propagation , accuracy and saving best model
...
for epoch in range(epochs):
    ...
    # save all train test results--- for plotting graphs 
...
#classification reprt , presiscion , recall , F1-score 
